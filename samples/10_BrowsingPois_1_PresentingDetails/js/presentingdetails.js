...
var World = {
    ...
    loadPoisFromJsonData: function loadPoisFromJsonDataFn(poiData) {
        ...
        for (var currentPlaceNr = 0; currentPlaceNr < poiData.length; currentPlaceNr++) {
            ...
            console.log("id", singlePoi.id);
            console.log("lat", singlePoi.latitude);
            console.log("lon", singlePoi.longitude);
            console.log("alti", singlePoi.altitude);
            console.log("title", singlePoi.title);
            console.log("des", singlePoi.description);


            World.markerList.push(new Marker(singlePoi));
        }

        //Testdata voor custom poi
        // var singlePoi = {
        //     "id": 1,
        //     "latitude": 51.31921278029065,
        //     "longitude": 4.855917466149653,
        //     "altitude": 0,
        //     "title": "Kerk van Beerse",
        //     "description": "Dit is de mooie kerk van het prachtige beerse"
        // }
    ...
    updateDistanceToUserValues: function updateDistanceToUserValuesFn() {
        for (var i = 0; i < World.markerList.length; i++) {
            //console.log(World.markerList[i].markerObject.locations[0]);
    ...
    */
    ...
    requestDataFromServer: function requestDataFromServerFn(lat, lon) {
        ...
        var jqxhr = $.getJSON("https://grumpy-pig-12.loca.lt/blokken", function(data) {
