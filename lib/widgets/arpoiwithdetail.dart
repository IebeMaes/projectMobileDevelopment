...
import 'package:campus_map/pages/quiz.dart';
import 'package:flutter/material.dart';

class ArPoiWithDetailWidget extends StatefulWidget {
  @override
  _ArPoiWithDetailWidgetState createState() => _ArPoiWithDetailWidgetState();
}

class _ArPoiWithDetailWidgetState extends State<ArPoiWithDetailWidget>
  ...
  Future<void> onArchitectWidgetCreated() async {
    this.architectWidget.load(
        "samples/10_BrowsingPois_1_PresentingDetails/index.html",
        onLoadSuccess,
        onLoadFailed);
    this.architectWidget.resume();
  ...
  void onJSONObjectReceived(Map<String, dynamic> jsonObject) async {
    debugPrint("id van de gekozen blok: " + jsonObject.toString());
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => QuizPage(id: jsonObject["id"])));
  }
}
